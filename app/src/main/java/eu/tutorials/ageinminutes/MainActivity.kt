...
class MainActivity : AppCompatActivity() {
    ...
    fun clickDatePicker(){
        ...
        val tvSelectedDateInHours:TextView = findViewById(R.id.tvSelectedDateInHours)
        val tvSelectedDateInDays:TextView = findViewById(R.id.tvSelectedDateInDays)
        val tvSelectedDateInYears:TextView = findViewById(R.id.tvSelectedDateInYears)
        ...
        val dpd = DatePickerDialog(this,{ _, selectedYear, selectedMonth, selectedDayOfMonth ->
            ...
            theDate?.let {
                ...
                val selectedDateInYears = (theDate.time/86400000)/365
                ...
                currentDate?.let {
                    ...
                    val currentDateToYears = (currentDate.time/86400000)/365
                    /**
